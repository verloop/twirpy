...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  serialized_pb=_b('\n\x11haberdasher.proto\x12\x0bhaberdasher\"0\n\x03Hat\x12\x0c\n\x04size\x18\x01 \x01(\x05\x12\r\n\x05\x63olor\x18\x02 \x01(\t\x12\x0c\n\x04name\x18\x03 \x01(\t\"\x16\n\x04Size\x12\x0e\n\x06inches\x18\x01 \x01(\x05\x32=\n\x0bHaberdasher\x12.\n\x07MakeHat\x12\x11.haberdasher.Size\x1a\x10.haberdasher.Hatb\x06proto3')
)
...
_HAT = _descriptor.Descriptor(
  name='Hat',
  full_name='haberdasher.Hat',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='size', full_name='haberdasher.Hat.size', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='color', full_name='haberdasher.Hat.color', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='name', full_name='haberdasher.Hat.name', index=2,
...
_SIZE = _descriptor.Descriptor(
  name='Size',
  full_name='haberdasher.Size',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='inches', full_name='haberdasher.Size.inches', index=0,
      number=1, type=5, cpp_type=1, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
Hat = _reflection.GeneratedProtocolMessageType('Hat', (_message.Message,), dict(
  ...
  # @@protoc_insertion_point(class_scope:haberdasher.Hat)
  ))
...
Size = _reflection.GeneratedProtocolMessageType('Size', (_message.Message,), dict(
  DESCRIPTOR = _SIZE,
  __module__ = 'haberdasher_pb2'
  # @@protoc_insertion_point(class_scope:haberdasher.Size)
  ))
...
_HABERDASHER = _descriptor.ServiceDescriptor(
  name='Haberdasher',
  full_name='haberdasher.Haberdasher',
  file=DESCRIPTOR,
  index=0,
  serialized_options=None,
  ...
  _descriptor.MethodDescriptor(
    name='MakeHat',
    full_name='haberdasher.Haberdasher.MakeHat',
    index=0,
